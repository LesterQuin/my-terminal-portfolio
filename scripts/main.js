...
function enterKey(e) {
  ...
  if (e.keyCode == 13) {
    ...
    git = commands.length;
    addLine("Ryan's Portfolio:~$ " + command.innerHTML, "no-animation", 0);
...
function router(cmd) {
  switch (cmd.toLowerCase()) {
    ...
    case "email":
      addLine(
        'Opening mailto:<a href="mailto:ryanquin.02@gmail.com">ryanquin.02@gmail.com</a>...',
        "color2",
        80
      );
      openNewTab(email);
    ...
    case "ls":
      addLine(
        "So you are a real programmer at heart ❤️. PS. It's just a website!<br>",
        "color2",
        0
      );
      break;
