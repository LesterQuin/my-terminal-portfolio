...
const about = [
  ...
  "focused on crafting scalable and performant web applications.",
  "<br>Experienced in both front-end and back-end technologies, <br> I bring ideas to life through clean, efficient code.",
  "<br>I enjoy solving challenging problems, <br> and love to explore new technologies.",
  "<br>",
